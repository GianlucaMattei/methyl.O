...
<img src="https://github.com/GianlucaMattei/methyl.O/blob/main/vignettes/genemodels.png" alt=" **Figure 1**: Schematic gene model " width="90%" height="90%">
...
![**Figure 4**: The plot shows on the left the beta Difference of Methylation between two compared conditions of specific TFs, STAT1 in this case, and the expression of target genes. ](https://github.com/GianlucaMattei/methyl.O/blob/main/vignettes/MethylationVsExpression.png)
